...
Table 4: Implementation plan for 2026 to close knowledge gaps and advance barrier rehabilitation to improve connectivity for Atlantic Salmon, American Eel, and Rainbow Smelt in the NE PEI watersheds. Steps to incorporate field data, update models, and revise this WCRP are also included. 
```{r}
#| label: table-4
#| tbl-cap: "Table 4: Implementation plan for 2026 to close knowledge gaps and advance barrier rehabilitation to improve connectivity for Atlantic Salmon, American Eel, and Rainbow Smelt in the NE PEI watersheds. Steps to incorporate field data, update models, and revise this WCRP are also included. "
#| echo: false
#| results: asis
#| warning: false
